    ...
    >
      ...
      >
        ...
        <p className="text-lg text-text-secondary-light leading-relaxed">
          Profissionais que transformaram a gestão de seus consultórios compartilham suas
          experiências.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          Ver planos <span className="material-symbols-outlined text-sm">arrow_forward</span>
        </a>
      </motion.div>
    </section>
  );
