        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="text-xs font-bold text-[#8A05BE] bg-[#8A05BE]/5 border border-[#8A05BE]/10 px-5 py-2.5 rounded-xl hover:bg-[#8A05BE]/10 transition-colors flex items-center gap-1.5"
            >
