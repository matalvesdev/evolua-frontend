...
export function WeeklyActivitiesPlan({
  ...
  return (
    <>
      <section className="glass-card rounded-[2rem] p-4 sm:p-6 md:p-8 border border-white">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1 max-w-lg">
                Exercícios sugeridos para realização em consultório e casa para reforçar o
                aprendizado.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full md:w-auto">
            <button
              ...
              className="w-full text-xs font-bold text-[#8A05BE] bg-[#8A05BE]/5 border border-[#8A05BE]/10 px-4 sm:px-5 py-2.5 rounded-xl hover:bg-[#8A05BE]/10 transition-colors flex items-center justify-center gap-1.5"
            >
              <span className="material-symbols-outlined text-[16px]">timeline</span>
              Ver Histórico
            </button>
            <button className="w-full text-xs font-bold text-gray-600 border border-gray-200 px-4 sm:px-5 py-2.5 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
